<?php
Class Laporankaspajak_all extends CI_Controller{
    ...
    function cetak(){
        ...
        $pdf->Cell(0,8,'',0,1,'L');
        $pdf->Cell(275,5,'Buku Kas Pajak',0,1,'C');
        ...
        $q = $this->db->query('SELECT 2_uraian.*,
                                        ...
                                        where 1_tahun_anggaran.status = "1" AND 4_buku_kas.sumber_tujuan like "%pajak%" order by 4_buku_kas.tgl asc')->result();
            $saldo = 0;
       foreach ($q as $r) {
