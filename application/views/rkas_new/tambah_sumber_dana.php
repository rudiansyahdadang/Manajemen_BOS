                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <br>
                      <form class="forms-sample" action="<?php echo base_url() ?>rkas_new/aksi_tambah_sumber_dana" method="POST" name="sumber">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="rutin" placeholder="Sumber Dana Rutin" name="rutin" onFocus="startCalc();" onBlur="stopCalc();" >
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Pusat</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="pusat" placeholder="Sumber Dana BOS Pusat" name="pusat" onFocus="startCalc();" onBlur="stopCalc();">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Provinsi</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="prov" placeholder="Sumber Dana BOS Provinsi" name="prov"  onFocus="startCalc();" onBlur="stopCalc();">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Kab/Kota</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="kota" placeholder="Sumber Dana BOS Kab/Kota" name="kota" onFocus="startCalc();" onBlur="stopCalc();">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Bantuan Lain</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="bl" placeholder="Sumber Dana Bantuan Lainnya" name="bl" onFocus="startCalc();" onBlur="stopCalc();">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Pendapatan Lainnya</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="pl" placeholder="Sumber Dana Pendapatan Lainnya" name="pl" onFocus="startCalc();" onBlur="stopCalc();">
                          </div>
                        </div>
                        <div class="form-group row">
