            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
             <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Perbaharui Pengeluaran</h4>
                      ...
                      <form class="forms-sample" action="<?php echo base_url() ?>buku_kas/aksi_perbaharui" method="POST" name="sumber">
                          ...
                          <div class="col-sm-9">
                            <select data-placeholder="Pilih Kategori Dana" class="chosen-select" tabindex="2" name="id_uraian">
                              ...
                              $array_id_uraian = json_decode(json_encode($perbaharui), True);
                                ...
                                foreach ($tampil_data_uraian_pengeluaran as $a1) { ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select data-placeholder="Pilih Tahun Anggaran" class="chosen-select" tabindex="2" name="id_tahun">
                              <?php 
                              $array_id_uraian = json_decode(json_encode($perbaharui), True);
                                foreach ($array_id_uraian as $id_tahun) { ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <?php 
                              $array_id_uraian = json_decode(json_encode($perbaharui), True);
                                foreach ($array_id_uraian as $tgl) { ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select data-placeholder="Pilih Kode Uraian" class="chosen-select" tabindex="2" name="no_kode">
                              <?php 
                              $array_id_uraian = json_decode(json_encode($perbaharui), True);
                                foreach ($array_id_uraian as $id_kode_uraian) { ?>
                                  <option value="<?php echo $id_kode_uraian['id_uraian'] ?>"><?php echo $id_kode_uraian['kode_uraian']." ".$id_kode_uraian['uraian'] ?></option>
                                <?php } 
                              foreach ($tampil_data_uraian_pengeluaran as $b ) { ?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <?php 
                              $array_id_uraian = json_decode(json_encode($perbaharui), True);
                                foreach ($array_id_uraian as $id_no_bukti) { ?>
                                    <input type="text" class="form-control" placeholder="Masukan Nomor Kode" name="no_bukti" value="<?php echo $id_no_bukti['no_bukti'] ?>">
                                <?php } ?>
                          </div>
                        </div>
                         <div class="form-group row">
                            ...
                            <?php 
                              $array_4_uraian = json_decode(json_encode($perbaharui), True);
                                foreach ($array_4_uraian as $uraian4) { ?>
                                  <input type="text" class="form-control" id="uraian" placeholder="Masukan Nama Uraian Secara Lengkap" name="uraian" value="<?php echo $uraian4['4_uraian'] ?>">
                                <?php } ?>
                          </div>
                        </div>
                        <input type="hidden" name="pemasukan_dana" value="0">
                         <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <?php 
                              $array_pengeluaran = json_decode(json_encode($perbaharui), True);
                                foreach ($array_pengeluaran as $pengeluaran) { ?>
                                  <input type="number" class="form-control" id="uraian" placeholder="Masukan Nama Uraian Secara Lengkap" name="pengeluaran_dana" value="<?php echo $pengeluaran['pengeluaran_dana'] ?>">
                                <?php } ?>
                          </div>
                        </div>
                        <div class="form-group row">
