...
<!--           KONTEN UNTAMA -->
            <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Buku Bank &nbsp;&nbsp; <a href="<?php echo base_url(); ?>buku_kas/tambah_pemasukan" class="btn btn-success btn-rounded btn-fw">Tambah Pemasukan Dana</a><a href="<?php echo base_url(); ?>buku_kas/tambah_pengeluaran" class="btn btn-danger btn-rounded btn-fw">Tambah Pengeluaran Dana</a></h4>
                  <form action="<?php echo base_url() ?>/buku_kas/laporan_bank" method="POST">
                    ...
                    <a target="_blank" href="<?php echo base_url().'laporankasbank_all/cetak/'?>" class="btn btn-success btn-rounded btn-fw">Cetak Buku Bank (All)</a>
                  ...
                  <table class="table center-aligned-table">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $a->sumber_tujuan ?> </td>
