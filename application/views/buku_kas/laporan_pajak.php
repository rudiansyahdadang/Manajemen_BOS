...
<!--           KONTEN UNTAMA -->
            <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Buku Pajak &nbsp;&nbsp; <a href="<?php echo base_url(); ?>buku_kas/tambah_pemasukan" class="btn btn-success btn-rounded btn-fw">Tambah Pemasukan Dana</a><a href="<?php echo base_url(); ?>buku_kas/tambah_pengeluaran" class="btn btn-danger btn-rounded btn-fw">Tambah Pengeluaran Dana</a><br></h4>
                    ...
                    <a href="#" class="btn btn-success btn-rounded btn-fw" data-izimodal-open="#modal-Large" data-izimodal-transitionin="fadeInDown">Lihat Buku Pajak</a>
                    <?php
                      if($bulan == 1){
                        $nama_bulan = "Januari";
                      }else if($bulan == 2){
                    ...
                    ?>
                    <a target="_blank" href="<?php echo base_url().'laporankaspajak/cetak/'.$bulan?>" class="btn btn-success btn-rounded btn-fw">Cetak Buku Kas Pajak (<?php echo $nama_bulan?>)</a>
...
<!--           KONTEN UNTAMA -->
  <div id="modal-Large" class="trigger-large"> 
    <table align="center" width="100%">
      <tr>
        <td align="center" colspan="10">BUKU PAJAK</td>
      </tr>
      <tr>
