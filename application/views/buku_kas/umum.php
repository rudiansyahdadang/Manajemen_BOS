...
<!--           KONTEN UNTAMA -->
            <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Buku Kas Umum &nbsp;&nbsp; <a href="<?php echo base_url(); ?>buku_kas/tambah_pemasukan" class="btn btn-success btn-rounded btn-fw">Tambah Pemasukan Dana</a><a href="<?php echo base_url(); ?>buku_kas/tambah_pengeluaran" class="btn btn-danger btn-rounded btn-fw">Tambah Pengeluaran Dana</a></h4>
                   <form action="<?php echo base_url() ?>/buku_kas/laporan_umum" method="POST">
                    ...
                    <a href="#" class="btn btn-success btn-rounded btn-fw" data-izimodal-open="#modal-Large" data-izimodal-transitionin="fadeInDown">Lihat Buku Kas Umum</a>
                    <a target="_blank" href="<?php echo base_url().'laporankasumum_all/cetak/'?>" class="btn btn-success btn-rounded btn-fw">Cetak Buku Kas Umum (All))</a>
...
<!--           KONTEN UNTAMA -->
   <div id="modal-Large" class="trigger-large"> 
    <table border="1" align="center">
      <tr>
        <td align="center" colspan="10">BUKU KAS UMUM</td>
      </tr>
      <tr>
